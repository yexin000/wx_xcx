      ...
      'success': function (res) {
        ...
        wx.showToast({
          ...
          complete: function () {
            ...
            prevPage.setData({
              mainViewUrl: "https://mlhdkj.com/weixin/foreground/html/lh/order.html"
            })
            wx.navigateBack();
          }
        });
      ...
      'fail': function (res) {
        ...
        wx.showToast({
          ...
          complete: function () {
            ...
            var prevPage = pages[pages.length - 2];
            prevPage.setData({
              mainViewUrl: "https://mlhdkj.com/weixin/foreground/html/lh/commodityDetail.html?id=" + itemId +"&payFail=true"
            })
            wx.navigateBack();
          }
        });
